...
import { RoleRequestDto, RoleToUserDto } from '@/dtos/roles.dto';
...
export class RoleRoute implements Routes {
    ...
    private initializeRoutes() {
        ...
        this.router.post(`${this.path}/role-to-user`, AuthMiddleware, ValidationMiddleware(RoleToUserDto), isAdmin, this.role.addRoleToUser);
        this.router.delete(`${this.path}/role-to-user`, AuthMiddleware, isAdmin, this.role.removeRoleFromUser);
